...
async function testLoginVisibility() {
  ...
  try {
    ...
    await page.waitForSelector('input[type="email"], input[type="password"], .btn-auth', { timeout: 15000 });
    
    // Cliquer sur le bouton de connexion si on est sur la page d'accueil
    const loginButtons = await page.$$('text="Se connecter"');
